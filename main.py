...
msg = MIMEMultipart()
msg['From'] = 'f5570868@gmail.com'
msg['To'] = 'nathan920@yandex.ru'
...
s.starttls()                                   
s.login('f5570868@gmail.com', 'wtlzgaixoclrdjjt')
s.sendmail('f5570868@gmail.com', 'nathan920@yandex.ru', msg.as_string())
s.quit()
i = input()